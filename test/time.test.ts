...
const CONVERSION_TESTS: [number, TimeUnit, number, TimeUnit][] = [
  ...
  [1, 'Week', 7, 'Day'],
  [1, 'Week', 1, 'Week'],
  [1, 'Week', 1 / 4.34524, 'Month'],
  [1, 'Week', (1 / 52.1429) * 4, 'Quarter'],
  [1, 'Week', 1 / 52.1429, 'Year'],
  // day conversions
  ...
  [1, 'Day', 1, 'Day'],
  [1, 'Day', 1 / 7, 'Week'],
  [1, 'Day', 1 / 7 / 4.34524, 'Month'],
  [1, 'Day', (1 / 365.2425) * 4, 'Quarter'],
  [1, 'Day', 1 / 365.2425, 'Year'],
  // hour conversions
  [1, 'Hour', 60 * 60, 'Second'],
  [1, 'Hour', 60, 'Minute'],
  [1, 'Hour', 1, 'Hour'],
  [1, 'Hour', 1 / 24, 'Day'],
  [1, 'Hour', 1 / 24 / 7, 'Week'],
  [1, 'Hour', 1 / 24 / 7 / 4.34524, 'Month'],
  [1, 'Hour', (1 / 24 / 365.2425) * 4, 'Quarter'],
  [1, 'Hour', 1 / 24 / 365.2425, 'Year'],
  // minute conversions
  [1, 'Minute', 60, 'Second'],
  [1, 'Minute', 1, 'Minute'],
  [1, 'Minute', 1 / 60, 'Hour'],
  ...
  [1, 'Minute', 1 / 60 / 24 / 7 / 4.34524, 'Month'],
  [1, 'Minute', (1 / 60 / 24 / 365.2425) * 4, 'Quarter'],
  [1, 'Minute', 1 / 60 / 24 / 365.2425, 'Year'],
  // second conversions
  [1, 'Second', 1, 'Second'],
  ...
  [1, 'Second', 1 / 60 / 24 / 7 / 4.34524, 'Month'],
  [1, 'Second', (1 / 60 / 60 / 24 / 365.2425) * 4, 'Quarter'],
  [1, 'Second', 1 / 60 / 60 / 24 / 365.2425, 'Year'],
]
